...
class BeerclubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beerclub" do
    assert_difference("Beerclub.count") do
      post beerclubs_url, params: { beerclub: { city: @beerclub.city, founded: @beerclub.founded, integer: @beerclub.integer, name: @beerclub.name, string: @beerclub.string } }
    end
  ...
  test "should update beerclub" do
    patch beerclub_url(@beerclub), params: { beerclub: { city: @beerclub.city, founded: @beerclub.founded, integer: @beerclub.integer, name: @beerclub.name, string: @beerclub.string } }
